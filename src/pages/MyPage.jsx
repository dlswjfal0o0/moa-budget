...
export default function MyPage() {
  ...
  const neuSettingsSheet = (
    <SettingsNeu
      ...
      showUtilities={showUtilities} setShowUtilities={setShowUtilities}
      showLoan={showLoan} setShowLoan={setShowLoan}
      aiAnalysisStyle={aiAnalysisStyle} setAiAnalysisStyle={setAiAnalysisStyle} aiShowAdvice={aiShowAdvice} setAiShowAdvice={setAiShowAdvice}
      notifyPaymentEnabled={notifyPaymentEnabled} setNotifyPaymentEnabled={setNotifyPaymentEnabled}
      notifyPaymentTime={notifyPaymentTime} setNotifyPaymentTime={setNotifyPaymentTime}
      notifyNightConsent={notifyNightConsent} setNotifyNightConsent={setNotifyNightConsent}
      notifyPermissionError={notifyPermissionError} setNotifyPermissionError={setNotifyPermissionError}
      categories={categories} setCategories={setCategories}
      settingsCatTab={settingsCatTab} setSettingsCatTab={setSettingsCatTab}
      settingsNewCatName={settingsNewCatName} setSettingsNewCatName={setSettingsNewCatName}
      fontScale={fontScale} setFontScale={setFontScale}
      exportToExcel={exportToExcel} exportToPDF={exportToPDF} exporting={exporting}
      updatesList={updatesList} expandedVersion={expandedVersion} setExpandedVersion={setExpandedVersion} APP_VERSION={APP_VERSION}
      deleteChecked={deleteChecked} setDeleteChecked={setDeleteChecked} setShowDeleteModal={setShowDeleteModal}
    />
  )
  ...
  if (neumorphism) {
    return (
      ...
      <MyPageNeu
        ...
        fmt={fmt} totalAsset={totalAsset} accounts={accounts} getAccountBalance={getAccountBalance} getCashBalance={getCashBalance}
        cards={cards} setCards={setCards} saveToFirestore={saveToFirestore}
        showAddCard={showAddCard} setShowAddCard={setShowAddCard}
        cardExitId={cardExitId} newCardId={newCardId} highlightCardId={highlightCardId}
        expandedCardId={expandedCardId} setExpandedCardId={setExpandedCardId} getCardUsed={getCardUsed}
        setSelectedCard={setSelectedCard} handleCardClick={handleCardClick}
        setEditingCardId={setEditingCardId} setEditCardData={setEditCardData} handleDeleteCard={handleDeleteCard}
        editingCardId={editingCardId} editCardData={editCardData}
        newCard={newCard} setNewCard={setNewCard} EMPTY_CARD={EMPTY_CARD}
        cardSaveState={cardSaveState} handleAddCard={handleAddCard} handleSaveCard={handleSaveCard}
        showAccountNumbers={showAccountNumbers} setShowAccountNumbers={setShowAccountNumbers}
        setShowAddAccount={setShowAddAccount} expandedAccountEditId={expandedAccountEditId} setExpandedAccountEditId={setExpandedAccountEditId}
        maskAccountNumber={maskAccountNumber} setSelectedAccount={setSelectedAccount} setAccountHistoryMonth={setAccountHistoryMonth}
        handleEditAccount={handleEditAccount} handleDeleteAccount={handleDeleteAccount}
        editingAccountId={editingAccountId} setEditingAccountId={setEditingAccountId} editAccountData={editAccountData} setEditAccountData={setEditAccountData}
        handleSaveAccount={handleSaveAccount} showAddAccount={showAddAccount} newAccount={newAccount} setNewAccount={setNewAccount} handleAddAccount={handleAddAccount}
        editingCash={editingCash} setEditingCash={setEditingCash} cashInput={cashInput} setCashInput={setCashInput} cash={cash} handleCashSave={handleCashSave}
        showLoan={showLoan} loans={loans} calcMonthlyInterest={calcMonthlyInterest}
        setSelectedLoan={setSelectedLoan} setLoanDetailSort={setLoanDetailSort}
        expandedLoanId={expandedLoanId} setExpandedLoanId={setExpandedLoanId}
        setLoanForm={setLoanForm} setEditingLoan={setEditingLoan} handleDeleteLoan={handleDeleteLoan} EMPTY_LOAN={EMPTY_LOAN}
        showAddLoan={showAddLoan} setShowAddLoan={setShowAddLoan} editingLoan={editingLoan} loanForm={loanForm}
        handleAddLoan={handleAddLoan} handleSaveLoan={handleSaveLoan}
        showDeleteModal={showDeleteModal} setShowDeleteModal={setShowDeleteModal} handleWithdrawAccount={handleWithdrawAccount} deletingAccount={deletingAccount}
        selectedCard={selectedCard} displayCard={displayCard} cardDetailTab={cardDetailTab} setCardDetailTab={setCardDetailTab}
        cardHistoryMonth={cardHistoryMonth} setCardHistoryMonth={setCardHistoryMonth} cardTransactions={cardTransactions}
        selectedAccount={selectedAccount} displayAccount={displayAccount} accountHistoryMonth={accountHistoryMonth} allTxns={allTxns}
        selectedLoan={selectedLoan} displayLoan={displayLoan} loanDetailSort={loanDetailSort} loanRepaymentTxns={loanRepaymentTxns} loadingRepayments={loadingRepayments}
        deleteConfirmCard={deleteConfirmCard} setDeleteConfirmCard={setDeleteConfirmCard} confirmDeleteCard={confirmDeleteCard}
        undoSnackbar={undoSnackbar} handleUndo={handleUndo}
      />
      {neuSettingsSheet}
      {deleteAccountSheet}
